...
class B2C
{
    ...
    public function __construct ()
    {
        ...
        $this->InitiatorName = config('gateway.module.gateway.mpesa.b2c.InitiatorName');
...
//Business To Customer
    ...
    public function getAuthUrl ()
    {
        ...
        return config('gateway.module.gateway.mpesa.b2c.is_live') == false ? 'https://sandbox.safaricom.co.ke/oauth/v1/generate?grant_type=client_credentials' : 'https://api.safaricom.co.ke/oauth/v1/generate?grant_type=client_credentials';
    }
    ...
    {
        return config('gateway.module.gateway.mpesa.b2c.is_live') == true ? 'https://api.safaricom.co.ke/mpesa/b2c/v1/paymentrequest' : 'https://sandbox.safaricom.co.ke/mpesa/b2c/v1/paymentrequest';
    }
